...
class RegisterView extends StatefulWidget {
  ...
  const RegisterView({required this.goBack, Key? key}) : super(key: key);
...
class _RegisterViewState extends State<RegisterView> {
  ...
  void _saveForm() async {
    ...
    if(isValid){
      ...
      await Provider.of<LoginProvider>(context, listen: false).registerUser(_toSend).whenComplete((){
              ...
              children: [
                Column(
                  children: const [
                    ...
                    Text('Por favor, regísrtate', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 22.5))
                  ],
                ),
                Column(
                  children: [
